...
if __name__=="__main__":
    actor_model_name_or_path = "/mnt/model/huggingface/Llama-3.2-3B-Instruct"
    ...
    actor_model.to("cuda:0")
    template = "<|begin_of_text|><|start_header_id|>user<|end_header_id|>\n\n{}<|eot_id|><|start_header_id|>assistant<|end_header_id|>\n\n"
    query = "How to live a better life?"
    instruction = template.format(query)
    ...
    sequences = actor_model.generate(
        input_ids=input_ids,
